        ...
        <div className=" max-w-7xl   mx-auto   px-4 sm:px-6   py-20   grid   grid-cols-1 md:grid-cols-2   gap-10 md:gap-20   items-center">
          ...
          <div className="flex flex-col gap-4 text-center md:text-left">
            ...
            <p className="text-sm sm:text-base text-blue leading-relaxed max-w-xl  mx-auto md:mx-0">
              Pathoconnect enables seamless sample collection, real-time
              tracking, and operational efficiency for labs and diagnostic
              centers.
            </p>

            <button
              onClick={() => setOpen(true)}
              className="customHover max-w-3xs mt-4 h-12 px-6 duration-300 rounded-full font-bold border border-primary bg-[#e85c41] text-white hover:bg-white hover:text-[#e85c41] transition w-full sm:w-auto mx-auto md:mx-0 flex flex-row items-center justify-center group "
            >
